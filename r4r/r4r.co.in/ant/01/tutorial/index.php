...
if (!$sconnection)
 ...
 $defaultTitle="Ant Basic Tutorials,Ant Basic Tutorials with Examples";
  $defaultPageHeader="Ant Basic Tutorials,Ant Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("Ant basic",$defaultPageHeader,"Ant_basic_tutorials.php"); 
