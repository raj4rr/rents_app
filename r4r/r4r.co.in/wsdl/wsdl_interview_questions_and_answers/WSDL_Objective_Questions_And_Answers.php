...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="WSDL Objective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>WSDL</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/wsdl/">WSDL</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/wsdl/wsdl_interview_questions_and_answers/">FAQS</a></div>
        <table>
          <tr>
