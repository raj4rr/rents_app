...
<HTML><HEAD><TITLE>Testing Basic Example,Testing Basic Examples,Testing Basic examples,example,Examples</TITLE>

<META http-equiv=content-type content="text/html; charset=iso-8859-1">
<META content="Rajesh Kumar" name="author">
<META http-equiv="expires" content="0">
<META content="r4r.co.in" name="owner">
<meta name="description" CONTENT="Testing Basic Example,Testing Basic Examples,Testing Basic examples,example,Examples" >
<meta name="keywords" CONTENT="Testing Basic Example,Testing Basic Examples,Testing Basic examples,example,Examples">
<LINK 
...
$rs = mysql_query("SELECT  COUNT(*)  FROM `sourcecode` WHERE  language='testing Basic Example' AND hide='NO' ") or die("Count query error!");
...
<br>
<a href="/">R4R </a>---><a href="/testing">Testing</a>-->> <a href="#">Testing Basic</a>--><a href="#">Testing Basic Example</a> -->>Testing Basic Example Index

<h2>Testing Basic Example,Testing Basic Examples,Testing Basic Examples,Example, Examples</h2>

<?php

    $rs = mysql_query("SELECT  *  FROM `sourcecode` WHERE  language='testing Basic Example'  ORDER BY  id  ASC LIMIT $start, $max ") or die("State query error!");
...
?>
<p>
<u><a href="testing_basic_examples.php?id=<?= htmlspecialchars($id) ?>&option=testing Basic Example"><b><?= htmlspecialchars($title) ?></a> </u>
   </b>
    <br/>                
