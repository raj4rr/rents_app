...
if (!$sconnection)
 ...
 $defaultTitle="asp.net Basic Tutorials,asp.net Basic Tutorials with Examples";
  $defaultPageHeader="asp.net Basic Tutorials,asp.net Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("asp.net basic",$defaultPageHeader,"asp.net_basic_tutorials.php"); 
