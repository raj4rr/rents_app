...
if (!$sconnection)
 ...
 $defaultTitle="ASP.NET Basic Tutrials";
  $defaultPageHeader="ASP.NET Basic Tutrials";
 $pagetitle="";
...
<?php
   ...
   displayContents("asp.net Example",$defaultPageHeader,"asp.net_basic_examples.php"); 
