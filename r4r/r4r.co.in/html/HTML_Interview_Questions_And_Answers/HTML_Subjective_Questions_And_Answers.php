...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="HTML Subjective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>HTML</h1>
        ...
        <a href="/html/">HTML</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/html/HTML_Interview_Questions_And_Answers/">FAQS</a></div>
        <table>
          <tr>
