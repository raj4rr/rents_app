...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="HR Interview Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>HR(Human Resource) Interview Question and Answers</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/hr/">HR(Human Resource)</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/hr/interviews-questions_answers/">HR(Human Resource) Interview Question and Answers</a></div>
        <table>
          <tr>
