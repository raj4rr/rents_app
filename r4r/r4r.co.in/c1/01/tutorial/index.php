...
if (!$sconnection)
 ...
 $defaultTitle="C# Basic Tutorials,C# Basic Tutorials with Examples";
  $defaultPageHeader="C# Basic Tutorials,C# Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("C# basic",$defaultPageHeader,"C1_basic_tutorials.php"); 
