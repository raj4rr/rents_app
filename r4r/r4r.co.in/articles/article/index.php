<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
   <meta name="description" content="Free Articles">
  <meta name="keyword" content="Post Articles">
...
?>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Articles-r4rcoin
      <small></small>
    </h1>
...
$stm = $pdo->prepare("select * from topic_p where publish='P' ORDER BY `topic_id` DESC");
		//	$stm->bindParam(":title", $title, PDO::PARAM_STR);
			$stm->execute();
