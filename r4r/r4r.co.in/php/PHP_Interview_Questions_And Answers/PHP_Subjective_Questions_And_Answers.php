...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="PHP Subjective Questions and Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>PHP</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/php/">PHP</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/php/PHP_Interview_Questions_And Answers/">FAQS</a></div>
        <table>
          <tr>
...
displayContents1("PHP SUB",$pdo);

?>			<h2><?php echo $title; ?></h2>									              <!--Footer  --></td>
          </tr>		
  									              <!--Footer  --></td>
          </tr>
        </table></td>
