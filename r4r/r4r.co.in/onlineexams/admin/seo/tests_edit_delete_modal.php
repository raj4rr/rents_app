    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="test_edit.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">test_desc</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="test_desc" value="<?php echo $row['test_desc']; ?>">
					</div>
				</div>
					<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">test_meta_desc</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="test_meta_desc" value="<?php echo $row['test_meta_desc']; ?>">
					</div>

				</div>
					<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">test_title</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="test_title" value="<?php echo $row['test_title']; ?>">
					</div>

				</div>
					<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">test_keyworlds</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="test_keyworlds" value="<?php echo $row['test_keyworlds']; ?>">
					</div>
				</div>
            </div> 
			</div>
