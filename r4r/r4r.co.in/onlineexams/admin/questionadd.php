...
extract($_POST);
$dflag=0;
$rs1=mysql_query("Select * from mst_question where que_desc='$addque'",$cn);

		  while($row1=mysql_fetch_array($rs1))
	  {
		  echo "<p align=center>Question Duplicate.</p>";
	  $dflag=1;
  }
  if($dflag==0){
mysql_query("insert into mst_question(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans,userid) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue','$userid')",$cn) or die(mysql_error());
...
<?php
$rs=mysql_query("Select * from mst_test where status =3 order by test_name ",$cn);
...
?>
    ...
    <tr>
      ...
      <td>
		  ...
		  <select name="anstrue"  id="anstrue" >
