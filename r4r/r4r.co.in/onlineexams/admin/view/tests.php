				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							...
							$sub_id = $_GET['sub_id'];
							$sql = "SELECT test.test_id as test_id,test.test_name as test_name ,test.status as status,test.total_que as total_que, s.sub_name as sub_name,s.sub_id as sub_id FROM mst_test test inner join mst_subject s on test.sub_id= s.sub_id where test.status!=2 and test.sub_id=".$sub_id;
