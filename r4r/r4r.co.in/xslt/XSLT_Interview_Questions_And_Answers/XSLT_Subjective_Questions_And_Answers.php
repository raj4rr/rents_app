...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="XSLT Subjective Questions And Answers";
 $pagetitle="";
...
<div class="main_content">
              <div class="heading">Extensible Stylesheet Language(XSLT) Subjective Questions And Answers</div>	

	<h2><?php echo $title; ?></h2>	
<?php

displayContents1("XSLT SUB",$pdo);
