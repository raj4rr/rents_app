...
if (!$sconnection)
 ...
 $defaultTitle="ADO.NET Basic Tutrials";
  $defaultPageHeader="ADO.NET Basic Tutrials";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>Extensible Stylesheet Language(XSLT)</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/xslt/">XSLT</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/xslt/XSLT_Interview_Questions_And_Answers/">FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Extensible Stylesheet Language(XSLT) Interview Questions And Answers</div>

<?php

   displayContents("Java Basic",$defaultPageHeader,"ADO.NET_basic_examples.php"); 
