         ...
         <?php while ($row_question = mysql_fetch_array($sql_question))
               { ?> 
				<tr>
					...
					<td class="alternate1" style="text-align:center;" id="<?php echo $row_question['interviewquestion_id'];?>"><?php if($row_question['question_publish']=='N'){?><img src="../images/check.png" style="padding:0px; background:none;"><?php }?></td>
				</tr>
		<?php } ?>      
	</table>
	</div>
