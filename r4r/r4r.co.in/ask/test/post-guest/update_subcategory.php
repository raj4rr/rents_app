...
if(isset($_SESSION['employee_id']))
{
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		{
			$sql_update_category="update subcategory set subcategory_name='$subcategory_name',subcategory_description='$subcategory_description',publish='$publish',subcategory_update_date='$date_now' where subcategory_id='$update_id'";
