...
require_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 $sql_category = mysql_query("select DISTINCT category_name,category_id from category where userid=2",$r4r_con);?>
         ...
         <?php $e=1;
               ...
               { ?> 
				<tr id="category<?php echo $e;?>">
					<td class="alternate1"><?php echo $row_category['category_name']; ?></td>
					<td class="alternate1" style="text-align:center;"><a href="?r_category=<?php echo $row_category['category_id']; ?>"><?php echo mysql_num_rows(mysql_query("select * from interviewquestion where category_id='$row_category[category_id]'"));?></a></td>
					...
					<a style="cursor:pointer;" onClick="delete_category('<?php echo $row_category['category_name']; ?>','<?php echo $e;?>');"><img style="padding:0px; background:none;" src="../images/close.png"></a>
					<?php } else {?>
...
<td style="width:70%; padding:5px; vertical-align:top;">
	<?php 
	if(isset($_GET['r_category']))$r_category=$_GET['r_category']; else $r_category='13';
