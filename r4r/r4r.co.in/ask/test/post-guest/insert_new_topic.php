...
if(isset($_SESSION['employee_id']))
{
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		if($_POST['subcategory_id']=="other")
		{
			...
			{
				$sqlinsert_newsubcat="INSERT INTO subcategory (category_id,subcategory_name,subcategory_description,subcategory_insert_date,publish) values ('$category_id','$new_subcategory','$subcategorydescription','$date_now','Y')";
		...
		{
			$sql_inserttopic="INSERT INTO topic (category_id,subcategory_id,publish,topic_name,topic_description,keyword,topic_short_desc,admin_id,insert_date) values ('$category_id','$subcategory_id','N','$topic_name','$topic_full_description','$metakeys','$topic_short_description','$_SESSION['employee_id']','$date_now')";
