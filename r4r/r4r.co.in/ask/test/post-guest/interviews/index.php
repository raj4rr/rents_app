...
function question_box(question_id)
{
	...
	$.ajax({type: "get",url: "question_box.php",data: "interviewquestion_id="+question_id,cache:false,dataType:"html",
	success: function (response){$('#content').html(response);},error:function(){}});
} 

function load_subcategory(category_id,interviewsubcategory_id){ 

		$("#interviewsubcategory_id").html("&nbsp;");
         $("#interviewsubcategory_id").append("<option value='0' id='updateImageLoader1'>Loading..</option>");
                  $.ajax({
                         type: "get",
                         url: "interviewsubcategory.php",
						 data: {parameter_id: category_id,interviewsubcategory_id:interviewsubcategory_id },
                         cache:false,
                         dataType:"html",
                         success: function (response) {
                            $("#interviewsubcategory_id").html(response);
...
function adddquestion_box()
{
	$('#question_box').fadeIn('slow');$("#question_box_back").css('display', 'block' );
	$.ajax({type: "get",url: "question_box.php",data: "interviewquestion_id=00000",cache:false,dataType:"html",
	success: function (response){$('#content').html(response);},error:function(){}});
} 
 ...
 <div class="header">
    ...
    <div class="grid_right">
        <ul class="navigation">
            ...
            <li><a class="pageactive" href="../">Post Topics</a></li>
