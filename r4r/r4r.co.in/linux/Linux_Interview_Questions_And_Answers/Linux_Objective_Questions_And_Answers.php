...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Linux Objective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>WPF</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/wpf/">WPF</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/wpf/wpf_interview_questions_and_answers/">FAQS</a></div>
        <table>
          <tr>
...
displayContents1("Linux OBJ",$pdo);
