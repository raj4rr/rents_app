...
if (!$sconnection)
 ...
 $defaultTitle="WPF Basic Tutorials,WPF Basic Tutorials with Examples";
  $defaultPageHeader="WPF Basic Tutorials,WPF Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("WPF  basic",$defaultPageHeader,"WPF_basic_tutorials.php"); 
