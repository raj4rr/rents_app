...
<form method="POST" action="" enctype="multipart/form-data">
	...
	<br>
	<textarea rows="4" cols="50" name="vdesc">
		</textarea>
	<br>
...
if(isset($_POST['submit'])){
 ...
 if($type!='mp4' && $type!='3gp' && $type!='avi'){
  ...
  if($uplaod_success){
   ...
   $result=mysqli_query($conn,"INSERT INTO videos(name,title,categoryname,vdesc,size,type) VALUES('$name','$title','$categoryname','$vdesc','$size','$type')");
   echo $result;
   if($result==TRUE){
