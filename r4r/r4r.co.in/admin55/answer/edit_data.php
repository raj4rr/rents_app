...
if(isset($_POST['btn-update']))
{
	...
	$sql_query = "UPDATE answer SET answer='$answer',username='$username',email='$email',hide='$hide' ,question_id='$question_id' WHERE answer_id=".$_GET['edit_id'];
	// sql query for update data into database
...
<div id="body">
    ...
    <td>
		...
		<select name="question_id" placeholder="question_id" required width="200px">
			...
			<?php 
	$sql_query_q="SELECT * FROM  question WHERE id='$question_id'";
