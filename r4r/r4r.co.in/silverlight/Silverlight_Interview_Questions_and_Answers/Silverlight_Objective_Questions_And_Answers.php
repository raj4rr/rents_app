...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Silverlight Objecive Questions And Answers";
 $pagetitle="";
...
<div class="main_content">	
  ...
  <div class="heading">Silverlight Objecive Questions And Answers</div>
<?php
echo "<h2>".$title."</h2>";
displayContents1("Silverlight OBJ",$pdo);
echo "<h2>".$title."</h2>";
