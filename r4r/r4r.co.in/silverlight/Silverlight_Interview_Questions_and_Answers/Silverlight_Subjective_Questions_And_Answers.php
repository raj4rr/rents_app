...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Silverlight Subjective Questions And Answers";
 $pagetitle="";
...
<div class="main_content">	
  ...
  <div class="heading">Silverlight Subjective Questions And Answers</div>
<?php
echo "<h2>".$title."</h2>";
displayContents1("Silverlight Sub",$pdo);
echo "<h2>".$title."</h2>";
