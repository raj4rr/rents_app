...
<HTML><HEAD><TITLE>Silverlight Basic Tutorials,Silverlight Basic Tutorials with Examples</TITLE>

<META http-equiv=content-type content="text/html; charset=iso-8859-1">
<META content="Rajesh Kumar" name="author">
<META http-equiv="expires" content="0">
<META content="r4r.co.in" name="owner">
<meta name="description" CONTENT="Silverlight Basic Tutorials,Silverlight Basic Tutorials with Examples" >
<meta name="keywords" CONTENT="Silverlight Basic Tutorials,Silverlight Basic Tutorials with Examples">
...
<a href="/">R4R </a><img src="/images/left_menu_bullet.gif" border="0" alt="Right Arrow" title="R4R CO IN Silverlight Example"><a href="/dotnet">Microsoft Technology</a><img src="/images/left_menu_bullet.gif" border="0" alt="Right Arrow" title="R4R CO IN Silverlight Example"> <a href="/silverlight/">Silverlight Tutorial</a>

</tr>
</table>
<center><p><font face="Verdana" color="#0066FF"><h3>Silverlight Basic Tutorials,Silverlight Basic Tutorials with Examples</h3></font></p></center>
...
$rs = mysql_query("SELECT  COUNT(*)  FROM `sourcecode` WHERE  language='Silverlight basic' AND hide='NO' ") or die("Count query error!");
...
<?php
    ...
    $rs = mysql_query("SELECT  *  FROM `sourcecode` WHERE  language='Silverlight basic'  ORDER BY  id  ASC LIMIT $start, $max ") or die("State query error!");

?>
    <h3><img src="/images/page.jpg" border="0" alt="Page" title="R4R CO IN Silverlight Example"><?= $page ?></h3>
...
?>
<p></p>
<u><a href="Silverlight_basic_tutorials.php?id=<?= htmlspecialchars($id) ?>&option=Silverlight basic"><b><?= htmlspecialchars($title) ?></a> </u>
...
?>
<br> <br>  <img src="/images/GoTo.gif" border="0" alt="Page" title="R4R CO IN Silverlight Example">
<?php
    for ($i = 1; $i <= $total_pages; $i++) {
        $txt = $i;
        if ($page != $i) 
