...
if (!$sconnection)
 ...
 $defaultTitle="Silverlight Basic Examples";
  $defaultPageHeader="Silverlight Basic Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("Silverlight Example",$defaultPageHeader,"Silverlight_basic_examples.php"); 
