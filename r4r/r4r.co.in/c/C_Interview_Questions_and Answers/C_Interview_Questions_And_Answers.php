...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="C Subjective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>C</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/c/">C </a><img src="/images/left_menu_bullet.gif"/>
         <a href="/c/C_Interview_Questions_and Answers/">FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">	
  ...
  <div class="heading">C Subjective Questions And Answers</div>
<?php

displayContents1("C SUB",$pdo);
