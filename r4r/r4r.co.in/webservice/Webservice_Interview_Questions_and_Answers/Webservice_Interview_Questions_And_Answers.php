...
if (!$connection)
 ...
 $defaultTitle="Webservice Interview Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>WebServices</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/webservice/">WebServices</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/webservice/Webservice_Interview_Questions_and_Answers/">FAQS</a></div>
        <table>
          <tr>
...
displayContents1("Webservice INTER");
