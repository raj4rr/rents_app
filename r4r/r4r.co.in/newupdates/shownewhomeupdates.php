<div style="height:1100px;overflow:scroll;width:300px;">
<?php
...
$result = mysql_query("SELECT * FROM `newupdates`  ORDER BY `newupdates`.`id` DESC LIMIT 0 , 100");
while (list($id, $title,$updates,$url,$name,$cdate) = mysql_fetch_row($result)) {
?>
<p>
<a href="<?=$url ?>"><b><?= htmlspecialchars($title);  ?></b></a><br/>
