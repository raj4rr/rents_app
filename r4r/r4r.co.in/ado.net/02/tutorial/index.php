...
if (!$sconnection)
 ...
 $defaultTitle="ADO.NET Basic Tutorials,ADO.NET Basic Tutorials with Examples";
  $defaultPageHeader="ADO.NET Basic Tutorials,ADO.NET Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("ADO.NET basic",$defaultPageHeader,"ADO.NET_basic_tutorials.php"); 
