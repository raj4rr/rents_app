...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="ADO.net Subjective  Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>ado.net</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/ado.net/">ado.net</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/ado.net/ADO.net_Interview_Questions_and Answers/">FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">	
 <div class="heading">ADO.net Subjective Questions And Answers</div>

<?php

displayContents1("ADO.net SUB",$pdo);
