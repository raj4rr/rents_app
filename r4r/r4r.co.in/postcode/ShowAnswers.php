    ...
    <font color="Red"><b>Title </font>:<pre><?= htmlspecialchars($title) ?></pre>
     <font color="Red"><b>Keywords </font>:<pre><?= htmlspecialchars($keywords) ?></pre>
      <font color="Red"><b>Descriptions </font>:<pre><?= htmlspecialchars($descriptions) ?></pre>
       <font color="Red"><b>Introduction </font>:<pre><?= ($introduction) ?></pre>
        <font color="Red"><b>Class Description </font>:<pre><?= ($classdescription) ?></pre>
         <font color="Red"><b>Method Description </font>:<pre><?= ($methoddescription) ?></pre>
          <font color="Red"><b>Class Description </font>:<pre><?= ($classdescription) ?></pre>
           <font color="Red"><b>Source Code Description </font>:<pre><?= ($sourcecodedescription) ?></pre>
            <font color="Red"><b>Source Code </font>:<pre><?= ($sourcecode) ?></pre>
             <font color="Red"><b>Output </font>:<pre><?= ($output) ?></pre>
              <font color="Red"><b>Language </font>:<pre><?= ($language) ?></pre> 
