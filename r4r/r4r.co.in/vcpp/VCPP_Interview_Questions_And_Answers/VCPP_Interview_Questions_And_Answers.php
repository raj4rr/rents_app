...
if (!$connection)
 ...
 $defaultTitle="VC++ Interview Questions And Answers";
 $pagetitle="";
...
<meta name="keywords" CONTENT="<?=htmlspecialchars($title) ?>"><script type="text/javascript" src="/js/main.js"></script>
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>VC++</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/vcpp/">VCPP</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/vcpp/VCPP_Interview_Questions_And_Answers/">FAQS</a></div>
        <table>
          <tr>
