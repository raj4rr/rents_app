...
if (!$connection)
 ...
 $defaultTitle="Inner Class,Coding a Regular Inner Class,Instantiating an Inner Class,Instantiating an Inner Class from Within Code in the Outer Class,Creating an Inner Class Object from Outside the Outer Class Instance Code,Referencing the Inner or Outer Instance from Within the Inner Class,Member Modifiers Applied to Inner Classes,Method-Local Inner Classes,What a Method-Local Inner Object Can and can't Do,Anonymous Inner Classes,Plain Old Anonymous Inner Classes, Flavor One,Plain Old Anonymous Inner Classes, Flavor Two,Argument-Defined Anonymous Inner Class,Static Nested Classes,Instantiating a Static Nested Class";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>OCJP(Oracle Certified  Java Program)</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/certifications/">Certifications </a><img src="/images/left_menu_bullet.gif"/>
         <a href="/certifications/ocjp/">OCJP Certifications</a></div>
        <table>
          <tr>
...
displayContents1("scjp1.5 chap9");
