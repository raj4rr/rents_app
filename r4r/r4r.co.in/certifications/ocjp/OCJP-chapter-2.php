...
if (!$connection)
 ...
 $defaultTitle="Declarations and Modifiers,Class Declarations and Modifiers,Class Access,Default Access,Public Access,Other (Nonaccess) Class Modifiers,Strictfp Methods";
 $pagetitle="";
...
displayContents1("SCJP1.5 chap2");
