...
if (!$connection)
 ...
 $defaultTitle="Writing Code Using if statement,Writing Code Using Switch Statement,Legal Arguments to switch and case,Iteration Expression";
 $pagetitle="";
...
displayContents1("scjp1.5 chap4");
