...
if (!$connection)
 ...
 $defaultTitle="Overriding hashCode() and equals().The toString() Method,Overriding equals(),The equals() Contract,Overriding hashCode(),Collections";
 $pagetitle="";
...
displayContents1("scjp1.5 chap8");
