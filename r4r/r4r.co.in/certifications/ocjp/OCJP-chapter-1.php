...
if (!$connection)
 ...
 $defaultTitle="Primitive Instance Variables,Variable Keyword,Error Handling,Package Control,Class, Method, and Variable Modifiers,Flow Control,Array,Literals,Command-Line Arguments to Main";
 $pagetitle="";
...
displayContents1("SCJP1.5 chap1");
