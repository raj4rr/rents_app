...
if (!$connection)
 ...
 $defaultTitle="Handling Exceptions,Catching an Exception Using try and catch,Using finally,Propagating Uncaught Exceptions,Propagating and Catching an Exception,Defining Exceptions,Exception Hierarchy,Handling an Entire Class Hierarchy of Exceptions,Exception Matching,Exception Declaration and the Public Interface,Rethrowing the Same Exception,Creating an Exception";
 $pagetitle="";
...
displayContents1("scjp1.5 chap5");
