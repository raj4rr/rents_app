...
if (!$connection)
 ...
 $defaultTitle="Source File declaration rules,default access,public access,Final classes,Abstract Classes,Creating an abstract super subclass concrete Subclass,Declaring an Interface,Declaring Interface Constants,final argument,synchronized method,native methods,Encapsulation,Inheritance,Polymorphism";
 $pagetitle="";
