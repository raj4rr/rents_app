...
if (!$sconnection)
 ...
 $defaultTitle="Spring Basic Example,Spring Basic Examples,Spring Basic examples,example, Examples";
  $defaultPageHeader="Spring Basic Example,Spring Basic Examples,Spring Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("Spring Example",$defaultPageHeader,"spring_basic_examples.php"); 
