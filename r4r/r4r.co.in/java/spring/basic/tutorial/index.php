...
if (!$sconnection)
 ...
 $defaultTitle="Spring Basic Tutorials,Spring Basic Tutorials with Examples";
  $defaultPageHeader="Spring Basic Tutorials,Spring Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("Spring Basic",$defaultPageHeader,"spring_basic_tutorials.php"); 
