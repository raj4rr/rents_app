...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Struts Interview Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>Spring</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a>
         <img src="/images/left_menu_bullet.gif"/> 
        <a href="/java/">Java</a>
        <img src="/images/left_menu_bullet.gif"/> 
        <a href="/java/spring/">Spring</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/java/spring/Spring_Interview_Questions_And_Answers/">FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Spring Interview Questions And Answers</div>

<?php

displayContents1("Struts INTER",$pdo);
