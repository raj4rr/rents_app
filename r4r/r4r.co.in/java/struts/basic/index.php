...
<HTML><HEAD><TITLE>Struts Basic Tutorials,Struts Basic Tutorials with Examples</TITLE>

<META http-equiv=content-type content="text/html; charset=iso-8859-1">
<META content="Rajesh Kumar" name="author">
<META http-equiv="expires" content="0">
<META content="r4r.co.in" name="owner">
<meta name="description" CONTENT="Struts Basic Tutorials,Struts Basic Tutorials with Examples" >
<meta name="keywords" CONTENT="Struts Basic Tutorials,Struts Basic Tutorials with Examples">
...
<a href="/">R4R </a><img src="/images/left_menu_bullet.gif" border="0" alt="Right Arrow" title="R4R CO IN Struts Tutorials"><a href="/java/struts">Struts</a><img src="/images/left_menu_bullet.gif" border="0" alt="Right Arrow" title="R4R CO IN Struts Tutorials"> <a href="/java/struts/basic/tutorial/index.php">Struts Basic</a><img src="/images/left_menu_bullet.gif" border="0" alt="Right Arrow" title="R4R CO IN Struts Tutorials"><a href="">Core Struts Basic Tutorial</a>
</tr>
</table>
<center><p><font face="Verdana" color="#0066FF"><h3>Struts Basic Tutorials,Struts Basic Tutorials with Examples</h3></font></p></center>
...
$rs = mysql_query("SELECT  COUNT(*)  FROM `sourcecode` WHERE  language='Struts Basic' AND hide='NO' ") or die("Count query error!");
...
?>          
 ...
 <img src="/images/total.gif" border="0" alt="Total" title="R4R CO IN Struts Tutorials"><?php echo $total; ?>  <img src="/images/GoTo.gif" border="0" alt="GoTO Page" title="R4R CO IN Struts Tutorials">
...
<?php
    ...
    $rs = mysql_query("SELECT  *  FROM `sourcecode` WHERE  language='Struts Basic'  ORDER BY  id  ASC LIMIT $start, $max ") or die("State query error!");

?>
    <h3><img src="/images/page.jpg" border="0" alt="Page" title="R4R CO IN Struts Tutorials"><?= $page ?></h3>
...
?>
<p></p>
<u><a href="struts_basic_tutorials.php?id=<?= htmlspecialchars($id) ?>&option=Struts Basic"><b><?= htmlspecialchars($title) ?></a> </u>
...
?>
<br> <br>  <img src="/images/GoTo.gif" border="0" alt="Page" title="R4R CO IN Struts Tutorials">
<?php
    for ($i = 1; $i <= $total_pages; $i++) {
        $txt = $i;
        if ($page != $i) 
...
?>
<br><?php @include($_SERVER['DOCUMENT_ROOT'] . '/common-files/ads2.shtml'); ?>
