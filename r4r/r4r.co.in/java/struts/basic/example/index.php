...
$title="Struts1.3 Example example  Basics in easy ways";
?>
...
<?php
    ...
    displayContents("Struts1.3 Example",$title,"struts_basic_examples.php",$pdo); 
// displayContents("Struts example",$defaultPageHeader,"struts_basic_examples.php"); 
    echo '<h2>'.$title.'</h2>';
