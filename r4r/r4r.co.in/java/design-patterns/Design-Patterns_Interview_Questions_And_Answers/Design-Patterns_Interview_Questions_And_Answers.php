...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Design-Patterns Interview Questions And Answers";
 $pagetitle="";
...
<div class="main_content">
              <div class="heading">Design Patterns Interview Questions And Answers</div>

<?php

displayContents1("Design-Patterns",$pdo);
