...
if (!$sconnection)
 ...
 $defaultTitle="JNDI example Tutorials,JNDI example Tutorials with Examples";
  $defaultPageHeader="JNDI example Tutorials,JNDI example Tutorials with Examples";
 $pagetitle="";
...
<?php 
   ...
   displayContents("JNDI example",$defaultPageHeader,"jndi_basic_examples.php"); 
