...
<HTML><HEAD><TITLE>IVR Basic Example,IVR Basic Examples,IVR Basic examples,example, Examples</TITLE>

<META http-equiv=content-type content="text/html; charset=iso-8859-1">
<META content="Rajesh Kumar" name="author">
<META http-equiv="expires" content="0">
<META content="r4r.co.in" name="owner">
<meta name="description" CONTENT="IVR Basic Example,IVR Basic Examples,IVR Basic examples,example, Examples" >
<meta name="keywords" CONTENT="IVR Basic Example,IVR Basic Examples,IVR Basic examples,example, Examples">
<LINK 
...
<a href="/">R4R </a><img src="../../../images/rightarrow.gif" border="0" alt="Right Arrow" title="R4R CO IN IVR Examples"><a href="/java/ivr">IVR</a><img src="../../../images/rightarrow.gif" border="0" alt="Right Arrow" title="R4R CO IN IVR Examples"> <a href="#">Core IVR Basic</a><img src="../../../images/rightarrow.gif" border="0" alt="Right Arrow" title="R4R CO IN IVR Examples"><a href="#">Core IVR Basic example</a> <img src="../../../images/rightarrow.gif" border="0" alt="Right Arrow" title="R4R CO IN IVR Examples"><a href="#">IVR Basic Example Index</a>

<h2>IVR Basic Example,IVR Basic Examples,IVR Basic examples,example, Examples</h2>
...
$rs = mysql_query("SELECT  COUNT(*)  FROM `sourcecode` WHERE  language='IVR Basic Example' AND hide='NO' ") or die("Count query error!");
...
?>          
 ...
 <img src="../../../images/total.gif" border="0" alt="Total" title="R4R CO IN IVR Examples"></font><?php echo $total; ?>  <img src="../../../images/GoTo.gif" border="0" alt="GoTO Page" title="R4R CO IN IVR Examples">
...
<?php
    ...
    $rs = mysql_query("SELECT  *  FROM `sourcecode` WHERE  language='IVR Basic Example'  ORDER BY  id  ASC LIMIT $start, $max ") or die("State query error!");

?>
    <h3><img src="../../../images/page.jpg" border="0" alt="Page" title="R4R CO IN IVR Examples"> <?= $page ?></h3>
...
?>
<p>
<u><a href="ivr_basic_examples.php?id=<?= htmlspecialchars($id) ?>&option=IVR Basic Example"><b><?= htmlspecialchars($title) ?></a> </u>
   </b>
    <br/>                
...
?>
<img src="../../../images/GoTo.gif" border="0" alt="GoTO Page" title="R4R CO IN IVR Examples">
