...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Hibernate Interview Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>Hibernate</h1>
           <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/>
             <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/> 
               <a href="/java/hibernate">Hibernate</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Hibernate Interview Questions And Answers</div>

<?php

displayContents1("Hibernate INTER",$pdo);
