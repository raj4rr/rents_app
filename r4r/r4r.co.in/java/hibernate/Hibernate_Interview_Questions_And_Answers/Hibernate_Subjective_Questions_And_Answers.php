...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Hibernate Subjective Questions And Answers";
 $pagetitle="";
...
<div class="main_content">
              <div class="heading">Hibernate Subjective Questions And Answers</div>

<?php

displayContents1("Hibernate SUB",$pdo);
