...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Hibernate Objective Questions And Answers";
 $pagetitle="";
...
<div class="main_content">
              <div class="heading">Hibernate Objective Questions And Answers</div>

<?php

displayContents1("Hibernate OBJ",$pdo);
