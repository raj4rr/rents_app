...
if (!$sconnection)
 ...
 $defaultTitle="Hibernate Basic Example,Hibernate Basic Examples,Hibernate Basic examples,example, Examples";
  $defaultPageHeader="Hibernate Basic Example,Hibernate Basic Examples,Hibernate Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("Hibernate Example",$defaultPageHeader,"hibernate_basic_examples.php"); 
