...
if (!$sconnection)
 ...
 $defaultTitle="Hibernate Basic Tutorials,Hibernate Basic Tutorials with Examples";
  $defaultPageHeader="Hibernate Basic Tutorials,Hibernate Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("Hibernate Basic",$defaultPageHeader,"hibernate_basic_tutorials.php"); 
