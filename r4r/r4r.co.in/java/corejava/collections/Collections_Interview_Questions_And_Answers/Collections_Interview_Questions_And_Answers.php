...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Collections Interview  Questions And Answers";
 $pagetitle="";
  ...
  <table cellpadding="3">
    <tr>
     ...
     <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a>
            <img src="/images/left_menu_bullet.gif"/> <a href="/java/">Java</a>
            <img src="/images/left_menu_bullet.gif"/> <a href="/java/corejava/collections/">Collections</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Collections Interview Questions And Answers</div>

<?php

displayContents1("Collections INTER",$pdo);
