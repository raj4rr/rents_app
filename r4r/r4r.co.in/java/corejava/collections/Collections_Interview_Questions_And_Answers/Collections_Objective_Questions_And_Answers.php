...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Collections Objective  Questions And Answers";
 $pagetitle="";
...
<div class="main_content">
              <div class="heading">Collections Objective Questions And Answers</div>

<?php

displayContents1("Collections OBJ",$pdo);
