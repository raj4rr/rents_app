...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Collections Subjective  Questions And Answers";
 $pagetitle="";
...
<div class="main_content">
              <div class="heading">Collections Subjective Questions And Answers</div>

<?php

displayContents1("Collections SUB",$pdo);
