...
$title="Java collections examples in easy ways";
?>
...
<?php
    ...
    displayContents("collections Examples",$title,"collections_basic_examples.php",$pdo); 

   // displayContents("collections examples",$defaultPageHeader,"collections_basic_examples.php"); 
    echo '<h2>'.$title.'</h2>';
