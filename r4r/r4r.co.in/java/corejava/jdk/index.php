...
<?php  require_once dirname(__FILE__) . '/../../../config/site_config.php';
 require_once $CONFIG['CORE_PATH'] . "../../../db/dbconnection.php"; 
  @include($_SERVER['DOCUMENT_ROOT'] . '/commonfiles/php/interviewQuestionsAndAnswers11.php');
...
if (!$connection)
 ...
 $defaultTitle="JDK Subjective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>COREJAVA</h1>
   <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/>
             <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/> 
               <a href="/java/corejava">COREJAVA</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">JDK Subjective Questions And Answers</div>

<?php

displayContents1("JDK SUB");
