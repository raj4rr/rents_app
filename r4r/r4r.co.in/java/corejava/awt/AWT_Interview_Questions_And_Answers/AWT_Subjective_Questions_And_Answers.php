...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Awt Subjective  Questions And Answers";
 $pagetitle="";
  ...
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>Core Java Programing laungage</h1>
         ...
         <img src="/images/left_menu_bullet.gif" width="11" height="6"> <a href="/java/corejava/awt">Awt Programming</a>                  
              </div>
            	<table>
          <tr>
...
<div class="main_content">
              <div class="heading">Awt Subjective Questions And Answers</div>

<?php

displayContents1("AWT SUB",$pdo);
