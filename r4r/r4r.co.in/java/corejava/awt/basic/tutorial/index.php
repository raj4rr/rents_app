...
if (!$sconnection)
 ...
 $defaultTitle="AWT Basic,AWT Basic with Examples";
  $defaultPageHeader="AWT Basic,AWT Basic with Examples";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
        <td style="width:83%;" valign="top"><h1>AWT</h1>
        ...
        <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/java/corejava/awt/">AWT</a></div>
...
<?php 
   ...
   displayContents("awt tutorial",$defaultPageHeader,"awt_basic_tutorials.php"); 
