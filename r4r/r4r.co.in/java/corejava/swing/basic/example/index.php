...
if (!$sconnection)
 ...
 $defaultTitle="Swing Basic,Swing Basic with Examples";
  $defaultPageHeader="Swing Basic,Swing Basic with Examples";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
        <td style="width:83%;" valign="top"><h1>Swing</h1>
        ...
        <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/java/corejava/swing/">Swing</a></div>
...
<?php 
   ...
   displayContents("swing Example",$defaultPageHeader,"swing_basic_examples.php"); 
