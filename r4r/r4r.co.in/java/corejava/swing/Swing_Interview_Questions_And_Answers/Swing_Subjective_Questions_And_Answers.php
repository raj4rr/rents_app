...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Swing Subjective  Questions And Answers";
 $pagetitle="";
    ...
    <tr>
      <td style="width:83%;" valign="top"> <h1>Core Java</h1>
        ...
        <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/java/corejava/swing/Swing_Interview_Questions_And_Answers"/>FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Swing Subjective Questions And Answers</div>

<?php

displayContents1("Swing INTER",$pdo);
