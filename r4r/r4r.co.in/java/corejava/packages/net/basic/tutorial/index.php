...
if (!$sconnection)
 ...
 $defaultTitle="Net Basic Tutorials,Net Basic Tutorials with Examples";
  $defaultPageHeader="Net Basic Tutorials,Net Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("net basic",$defaultPageHeader,"net_basic_tutorials.php"); 
