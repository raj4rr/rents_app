...
if (!$connection)
 ...
 $defaultTitle="Net Interview Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
         <td style="width:83%;" valign="top"><h1>Java Programing laungage</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/java/corejava/packages/net/">Net</a><img src="/images/left_menu_bullet.gif"/>
             <a href="/java/corejava/packages/net/net_Interview_Questions_And_Answers/">FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Net Interview Questions And Answers</div>

<?php

displayContents1("net INTER");
