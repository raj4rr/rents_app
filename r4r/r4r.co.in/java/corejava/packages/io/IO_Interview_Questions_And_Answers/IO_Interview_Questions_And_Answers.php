...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="IO Interview Questions And Answers";
 $pagetitle="";
 ...
 <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a>
            ...
            <a href="/java/">Java</a>
              <img src="/images/left_menu_bullet.gif" width="11" height="6"/>
               ...
               <img src="/images/left_menu_bullet.gif" width="11" height="6"/> 
               <a href="/java/corejava/packages">Package</a>
                    </div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">IO Interview Questions And Answers</div>

<?php

displayContents1("IO INTER",$pdo);
