...
if (!$sconnection)
 ...
 $defaultTitle="IO Basic,IO Basic with Examples";
  $defaultPageHeader="IO Basic,IO Basic with Examples";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
        <td style="width:83%;" valign="top"><h1>IO</h1>
  <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/java/corejava/">Core Java</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/java/corejava/packages/io/">IO</a></div>
...
<?php 
   ...
   displayContents("IO Example",$defaultPageHeader,"io_basic_examples.php"); 
