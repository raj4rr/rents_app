...
if (!$sconnection)
 ...
 $defaultTitle="IO Basic Tutorials,IO Basic Tutorials with Examples";
  $defaultPageHeader="IO Basic Tutorials,IO Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("io basic",$defaultPageHeader,"io_basic_tutorials.php"); 
