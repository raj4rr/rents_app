...
if (!$sconnection)
 ...
 $defaultTitle="Applets Basic,Applets Basic with Examples";
  $defaultPageHeader="Applets Basic,Applets Basic with Examples";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
        <td style="width:83%;" valign="top"><h1>Applets</h1>
        ...
        <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/java/corejava/applets/">Applets</a></div>
...
<?php 
   ...
   displayContents("Applets Basic",$defaultPageHeader,"applets_basic_tutorials.php"); 
