...
$rsprev = mysql_query("SELECT id FROM `sourcecode` WHERE  id<'$currentpageID' and language='servlet Example' AND hide='NO' ORDER BY id DESC limit 1") or die("Pgination1::-State query error!". mysql_error());
...
$rsnext = mysql_query("SELECT  id  FROM `sourcecode` WHERE  id>'$currentpageID' and language='servlet Example' AND hide='NO' ORDER BY id asc limit 1 ") or die("Pgination2::-State query error!");
if(!mysql_numrows($rsnext)>0)
    ...
    $rs = mysql_query("SELECT  *  FROM `sourcecode` WHERE  id='$currentpageID' and language='servlet Example' AND hide='NO'") or die("State query error!");
...
<a href="servlet_basic_examples.php?qid=<?php echo $prevID; ?>">
...
<a href="servlet_basic_examples.php?qid=<?php echo $nextID; ?>"><img src="/images/next.gif" border="0" alt="Next" title="Next"></a>
