...
if (!$sconnection)
 ...
 $defaultTitle="Servlet Basic Tutorials,Servlet Basic Tutorials with Examples";
  $defaultPageHeader="Servlet Basic Tutorials,Servlet Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("servlet basic",$defaultPageHeader,"servlet_basic_tutorials.php"); 
