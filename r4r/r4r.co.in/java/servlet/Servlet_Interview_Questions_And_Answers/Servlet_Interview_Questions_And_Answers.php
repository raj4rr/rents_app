...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Servlet Interview Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>Servlet</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/>
             ...
             <a href="/java/servlet">Servlet</a><img src="/images/left_menu_bullet.gif"/> 
             <a href="/java/servlet/Servlet_Interview_Questions_And_Answers">FAQ</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Servlet Interview Questions And Answers</div>
<?php

displayContents1("Servlet INTER",$pdo);
?>
