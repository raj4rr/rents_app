...
if (!$sconnection)
 ...
 $defaultTitle="RMI Basic Example,RMI Basic Examples,RMI Basic examples,example, Examples";
  $defaultPageHeader="RMI Basic Example,RMI Basic Examples,RMI Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("RMI Example",$defaultPageHeader,"rmi_basic_examples.php"); 
