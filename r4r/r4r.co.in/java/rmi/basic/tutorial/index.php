...
if (!$sconnection)
 ...
 $defaultTitle="RMI Basic Tutorials,RMI Basic Tutorials with Examples";
  $defaultPageHeader="RMI Basic Tutorials,RMI Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("rmi basic",$defaultPageHeader,"rmi_basic_tutorials.php"); 
