...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="RMI Subjective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>RMI</h1>
        <div class="link_menu"> <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/> 
              <a href="/java/">Java</a><img src="/images/left_menu_bullet.gif"/> 
              <a href="/java/rmi/">RMI</a><img src="/images/left_menu_bullet.gif"/> 
             <a href="/java/rmi/RMI_Interview_Questions_And_Answers">FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">RMI Subjective Questions And Answers</div>

<?php

displayContents1("RMI SUB",$pdo);
