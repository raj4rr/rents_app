...
if (!$sconnection)
 ...
 $defaultTitle="iText Basic Example,iText Basic Examples,iText Basic examples,example, Examples";
  $defaultPageHeader="iText Basic Example,iText Basic Examples,iText Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("itext Example",$defaultPageHeader,"itext_basic_examples.php"); 
