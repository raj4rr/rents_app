...
if (!$sconnection)
 ...
 $defaultTitle="iText Basic Tutorials,iText Basic Tutorials with Examples";
  $defaultPageHeader="iText Basic Tutorials,iText Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("itext basic",$defaultPageHeader,"itext_basic_tutorials.php"); 
