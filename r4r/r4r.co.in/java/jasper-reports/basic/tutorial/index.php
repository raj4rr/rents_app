...
if (!$sconnection)
 ...
 $defaultTitle="Jasper-Reports Basic Example,Jasper-Reports Basic Examples,Jasper-Reports Basic examples,example, Examples";
  $defaultPageHeader="Jasper-Reports Basic Example,Jasper-Reports Basic Examples,Jasper-Reports Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("Jasper-Reports Example",$defaultPageHeader,"jasper-reports_basic_tutorials.php"); 
