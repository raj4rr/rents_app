...
if (!$sconnection)
 ...
 $defaultTitle="JMS example Tutorials,JMS example Tutorials with Examples";
  $defaultPageHeader="JMS example Tutorials,JMS example Tutorials with Examples";
 $pagetitle="";
...
<?php 
   ...
   displayContents("JMS example",$defaultPageHeader,"jms_basic_examples.php"); 
