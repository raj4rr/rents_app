...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Java Xml Subjective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>Java Xml</h1>
     <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a>
            <img src="/images/left_menu_bullet.gif"/>
             <a href="/java/">Java</a>
             <img src="/images/left_menu_bullet.gif"/>
             <a href="/java/javaxml/">JavaXML</a><img src="/images/left_menu_bullet.gif"/> 
             <a href="/java/javaxml/javaxml_Interview_Questions_And_Answers">JavaXML</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">Java Xml Subjective Questions And Answers</div>

<?php

displayContents1("javaxml SUB",$pdo);
