...
if (!$sconnection)
 ...
 $defaultTitle="Java XML Basic Tutorials,Java XML Basic Tutorials with Examples";
  $defaultPageHeader="Java XML Basic Tutorials,Java XML Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("JavaXML Basic",$defaultPageHeader,"javaxml_basic_tutorials.php"); 
