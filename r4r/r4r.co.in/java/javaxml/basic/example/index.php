...
if (!$sconnection)
 ...
 $defaultTitle="Java XML Basic Example,Java XML Basic Examples,Java XML Basic examples,example, Examples";
  $defaultPageHeader="Java XML Basic Example,Java XML Basic Examples,Java XML Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("JavaXML Example",$defaultPageHeader,"javaxml_basic_examples.php"); 
