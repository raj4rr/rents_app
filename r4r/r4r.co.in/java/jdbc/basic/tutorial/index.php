...
if (!$sconnection)
 ...
 $defaultTitle="JDBC example Tutorials,JDBC example Tutorials with Examples";
  $defaultPageHeader="JDBC example Tutorials,JDBC example Tutorials with Examples";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
        <td style="width:83%;" valign="top"><h1>JDBC</h1>
...
<?php 
   ...
   displayContents("JDBC example",$defaultPageHeader,"jdbc_basic_tutorials.php"); 
