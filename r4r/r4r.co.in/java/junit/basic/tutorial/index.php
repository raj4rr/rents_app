...
if (!$sconnection)
 ...
 $defaultTitle="JUnit Basic Tutorials,JUnit Basic Tutorials with Examples";
  $defaultPageHeader="JUnit Basic Tutorials,JUnit Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("junit basic",$defaultPageHeader,"junit_basic_tutorials.php"); 
