...
if (!$sconnection)
 ...
 $defaultTitle="JUnit Basic Example,JUnit Basic Examples,JUnit Basic examples,example, Examples";
  $defaultPageHeader="JUnit Basic Example,JUnit Basic Examples,JUnit Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("junit Example",$defaultPageHeader,"junit_basic_examples.php"); 
