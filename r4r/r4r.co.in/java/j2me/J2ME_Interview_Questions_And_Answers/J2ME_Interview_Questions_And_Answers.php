...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="J2ME Interview  Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>J2ME</h1>
       <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a>
            <img src="/images/left_menu_bullet.gif"/>
             <a href="/java/">Java</a>
             <img src="/images/left_menu_bullet.gif"/>
             <a href="/java/j2me/">J2ME</a><img src="/images/left_menu_bullet.gif"/> 
             <a href="/java/j2me/J2ME_Interview_Questions_And_Answers/">J2ME FAQS</a></div>
        <table>
          <tr>
...
<div class="main_content">
              <div class="heading">J2ME Interview Questions And Answers</div>

<?php

displayContents1("J2ME INTER",$pdo);
