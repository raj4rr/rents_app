...
if (!$sconnection)
 ...
 $defaultTitle="JSP Basic,JSP Basic with Examples";
  $defaultPageHeader="JSP Basic,JSP Basic with Examples";
 $pagetitle="";
...
<?php 
   ...
   displayContents("JSP Basic tutorials",$defaultPageHeader,"jsp_basic_tutorials.php"); 
