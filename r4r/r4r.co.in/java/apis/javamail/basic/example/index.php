...
if (!$sconnection)
 ...
 $defaultTitle="Java Mail APIs Basic Example,Java Mail APIs Basic Examples,Java Mail APIs Basic examples,example, Examples";
  $defaultPageHeader="Java Mail APIs Basic Example,Java Mail APIs Basic Examples,Java Mail APIs Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("javamail examples",$defaultPageHeader,"javamail_basic_examples.php"); 
