...
if (!$sconnection)
 ...
 $defaultTitle="Java Mail APIs Basic Tutorials,Java Mail APIs Basic Tutorials with Examples";
  $defaultPageHeader="Java Mail APIs Basic Tutorials,Java Mail APIs Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("javamail basic",$defaultPageHeader,"javamail_basic_tutorials.php"); 
