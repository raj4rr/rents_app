...
<HTML><HEAD><TITLE>iText Basic Tutorials,iText Basic Tutorials with Examples</TITLE>

<META http-equiv=content-type content="text/html; charset=iso-8859-1">
<META content="Rajesh Kumar" name="author">
<META http-equiv="expires" content="0">
<META content="r4r.co.in" name="owner">
<meta name="description" CONTENT="iText Basic Tutorials,iText Basic Tutorials with Examples" >
<meta name="keywords" CONTENT="iText Basic Tutorials,iText Basic Tutorials with Examples">
...
require_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 include($_SERVER['DOCUMENT_ROOT'] . "/template/header.php"); ?>
  ...
  <tr>
    <td width="100%">
<a href="/">R4R </a><img src="/images/left_menu_bullet.gif" border="0" alt="Right Arrow" title="R4R CO IN itext Example"><a href="/java">Java</a><img src="/images/left_menu_bullet.gif" border="0" alt="Right Arrow" title="R4R CO IN itext Example"> <a href="/java/apis/itext/basic/tutorial/">iText Tutorial</a></tr>
</table>
<center><p><font face="Verdana" color="#0066FF"><h3>iText Basic Tutorials,iText Basic Tutorials with Examples</h3></font></p></center>
...
$rs = mysql_query("SELECT  COUNT(*)  FROM `sourcecode` WHERE  language='itext basic' AND hide='NO' ") or die("Count query error!");
...
?>          
 ...
 <img src="/images/total.gif" border="0" alt="Total" title="R4R CO IN itext Example"><?php echo $total; ?>  <img src="/images/GoTo.gif" border="0" alt="GoTO Page" title="R4R CO IN itext Example">
...
<?php
    ...
    $rs = mysql_query("SELECT  *  FROM `sourcecode` WHERE  language='itext basic'  ORDER BY  id  ASC LIMIT $start, $max ") or die("State query error!");

?>
    <h3><img src="/images/page.jpg" border="0" alt="Page" title="R4R CO IN itext Example"><?= $page ?></h3>
...
?>
<p></p>
<u><a href="itext_basic_tutorials.php?id=<?= htmlspecialchars($id) ?>&option=itext basic"><b><?= htmlspecialchars($title) ?></a> </u>
...
?>
<br> <br>  <img src="/images/GoTo.gif" border="0" alt="Page" title="R4R CO IN itext Example">
<?php
    for ($i = 1; $i <= $total_pages; $i++) {
        $txt = $i;
        if ($page != $i) 
