...
if (!$sconnection)
 ...
 $defaultTitle="EJB Basic Tutorials,EJB Basic Tutorials with Examples";
  $defaultPageHeader="EJB Basic Tutorials,EJB Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("ejb basic",$defaultPageHeader,"ejb_basic_tutorial.php"); 
