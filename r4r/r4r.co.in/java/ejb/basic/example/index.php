...
if (!$sconnection)
 ...
 $defaultTitle="EJB Basic Example,EJB Basic Examples,EJB Basic examples,example, Examples";
  $defaultPageHeader="EJB Basic Example,EJB Basic Examples,EJB Basic examples,example, Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("EJB Example",$defaultPageHeader,"ejb_basic_examples.php"); 
