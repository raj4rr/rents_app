...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="EJB Interview  Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>EJB</h1>
...
<div class="main_content">
              <div class="heading">EJB Interview Questions And Answers</div>
<?php

displayContents1("EJB INTER",$pdo);
