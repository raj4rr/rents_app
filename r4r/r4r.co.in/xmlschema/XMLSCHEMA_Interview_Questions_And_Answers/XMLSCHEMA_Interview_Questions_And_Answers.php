...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="XML SCHEMA Interview Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>XMLSCHEMA</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/xmlschema/">XMLSCHEMA</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/xmlschema/XMLSCHEMA_Interview_Questions_And_Answers/">FAQS</a></div>
        <table>
          <tr>
...
displayContents1("XMLSCHEMA SUB",$pdo);
