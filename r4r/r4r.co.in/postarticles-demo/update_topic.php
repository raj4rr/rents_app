...
if(isset($_SESSION['employee_id']))
{
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		if($_POST['subcategory_id']=="other")
		{
			...
			{
				$sqlinsert_newsubcat="INSERT INTO subcategory_p (category_id,subcategory_name,subcategory_description,subcategory_update_date,publish) values ('$category_id','$new_subcategory','$subcategorydescription','$date_now','P')";
		...
		if(isset($_POST['publish'])) $publish='P'; else $publish='N';
		...
		{
			$sql_updatetopic="update topic_p set category_id='$category_id',subcategory_id='$subcategory_id',publish='$publish',topic_name='$topic_name',topic_description='$topic_full_description',keyword='$metakeys',topic_short_desc='$topic_short_description',update_date='$date_now' where topic_id='$topic_id'";
