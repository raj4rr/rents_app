...
$sql_fortopic=mysql_query("SELECT * from topic_p WHERE topic_id='$_REQUEST['update_topic_id']'");
$row_fortopic=mysql_fetch_array($sql_fortopic);
?>
<script>
	<?php if($row_fortopic['publish']=='P'){?>
        ...
        <?php }?>
            ...
            <div class="tableContent" style="border-bottom:none;">
				...
				<tr>
					...
					{
                    	$sql_subcategory = mysql_query("select * from subcategory_p where category_id='$row_fortopic[category_id]' and ispublic='Y'");?>	<option value="0">--Select subcategory--</option>
