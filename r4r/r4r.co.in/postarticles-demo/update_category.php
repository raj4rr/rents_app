...
if(isset($_SESSION['employee_id']))
{
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		{
			$sql_update_category="update category_p set category_name='$category_name',category_description='$category_description',category_keyword='$category_keyword',ispublice='$publish',category_update_date='$date_now' where category_id='$update_id'";
