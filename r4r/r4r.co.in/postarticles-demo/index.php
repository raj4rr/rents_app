...
{?>
 ...
 <div class="header">
    ...
    <div class="grid_right">
        <ul class="navigation">
        	 <?php if(isset($_REQUEST['r']) && $_REQUEST['r']=='category'){?>
        	<li><a class="pageactive">Category</a></li>
            <?php } else {?> <li><a href="?r=category">Category</a></li><?php }?>

            <?php if(isset($_REQUEST['r']) && $_REQUEST['r']=='subcategory'){?>
        	<li><a class="pageactive">Subcategory</a></li>
            <?php } else {?> <li><a href="?r=subcategory">Subcategory</a></li><?php }?>

        	<?php if(isset($_REQUEST['r'])==''){?>
        	<li><a class="pageactive">Insert</a></li>
            <?php } else {?><li><a href="../postarticles">Insert</a></li><?php }?>
