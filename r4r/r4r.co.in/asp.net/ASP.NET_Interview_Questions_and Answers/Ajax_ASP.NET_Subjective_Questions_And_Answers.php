...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Ajax ASP.NET Subjective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>ASP.Net</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/asp.net/">ASP.net</a><img src="/images/left_menu_bullet.gif"/>
...
<div class="main_content">	
  ...
  <div class="heading">Ajax ASP.NET Subjective Questions And Answers</div>
<?php

displayContents1("Ajax ASP.NET SUB",$pdo);
