...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="Ajax ASP.NET Obective Questions And Answers";
 $pagetitle="";
...
<div class="main_content">	
  ...
  <div class="heading">Ajax ASP.NET Objective Questions And Answers</div>
<?php

displayContents1("Ajax ASP.NET OBJ",$pdo);
