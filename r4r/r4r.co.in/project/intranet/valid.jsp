...
<body bgcolor="#FFFFFF">
	...
	<BR><font color="Red">Your Message Has Been Send</font>
	...
	if (user_src!=null){
        ...
        <%if(To!=null){%><br>To:<%=To %><%}
         if(Bcc!=null){%><br>Bcc:<%=Bcc %><%}
         if(Cc!=null){%><br>Ccc:<%=Cc %><%}%>
         <br><input type="submit" value="Add In to AddressBook">
...
</body><%} else {out.println("Session is Expired <a href='Login.htm'>Login</a>");}%>
</body>
