...
<HTML><HEAD><TITLE>WML Basic Example,WML Basic Examples,WML Basic examples,example, Examples</TITLE>

<META http-equiv=content-type content="text/html; charset=iso-8859-1">
<META content="Rajesh Kumar" name="author">
<META http-equiv="expires" content="0">
<META content="r4r.co.in" name="owner">
<meta name="description" CONTENT="WML Basic Example,WML Basic Examples,WML Basic examples,example, Examples" >
<meta name="keywords" CONTENT="WML Basic Example,WML Basic Examples,WML Basic examples,example, Examples">
...
<center><p><font face="Verdana" color="#0066FF"><h3>WML Basic Example,WML Basic Examples,WML Basic examples,example, Examples</h3></font></p></center>
...
$rs = mysql_query("SELECT  COUNT(*)  FROM `sourcecode` WHERE  language='WML Example' AND hide='NO' ") or die("Count query error!");
...
?>          
 ...
 <img src="/images/total.gif" border="0" alt="Total" title="R4R CO IN WML Example"><?php echo $total; ?>  <img src="/images/GoTo.gif" border="0" alt="GoTO Page" title="R4R CO IN WML Example">
...
<?php
    ...
    $rs = mysql_query("SELECT  *  FROM `sourcecode` WHERE  language='WML Example'  ORDER BY  id  ASC LIMIT $start, $max ") or die("State query error!");

?>
    <h3><img src="/images/page.jpg" border="0" alt="Page" title="R4R CO IN WML Example"><?= $page ?></h3>
...
?>
<p></p>
<u><a href="WML_basic_examples.php?id=<?= htmlspecialchars($id) ?>&option=WML Example"><b><?= htmlspecialchars($title) ?></a> </u>
...
?>
<br> <br>  <img src="/images/GoTo.gif" border="0" alt="Page" title="R4R CO IN WML Example">
<?php
    for ($i = 1; $i <= $total_pages; $i++) {
        $txt = $i;
        if ($page != $i) 
