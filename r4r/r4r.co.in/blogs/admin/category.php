...
$categories = Category::getPage($conn, $paginator->limit, $paginator->offset,0);		// Show articles with page containing 5 article limit and 0 offset value
							...
							<?php foreach ($categories as $category): ?>
								<tr>
									<td>
										...
										<?= htmlspecialchars($category['menu']); ?>
										</td>
										<td>
