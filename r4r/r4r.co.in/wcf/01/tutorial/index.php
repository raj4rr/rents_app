...
if (!$sconnection)
 ...
 $defaultTitle="WCF Basic Tutorials,WCF Basic Tutorials with Examples";
  $defaultPageHeader="WCF Basic Tutorials,WCF Basic Tutorials with Examples";
 $pagetitle="";
...
<?php
   ...
   displayContents("WCF basic",$defaultPageHeader,"WCF_basic_tutorials.php"); 
