...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="XHTML Objective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>XHTML</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/xhtml/">XHTML</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/xhtml/xhtml_interview_questions_and_answers/">FAQS</a></div>
        <table>
          <tr>
...
displayContents1("XHTML OBJ",$pdo);
