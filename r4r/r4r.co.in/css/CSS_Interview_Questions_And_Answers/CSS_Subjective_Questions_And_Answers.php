...
<?php  include_once($_SERVER['DOCUMENT_ROOT'] . '/config/database.php');
 ...
 $defaultTitle="CSS Subjective Questions And Answers";
 $pagetitle="";
...
<div class="page_wrapper" style=" padding-top:10px;">
  <table cellpadding="3">
    <tr>
      <td style="width:83%;" valign="top"><h1>CSS</h1>
        <div class="link_menu"><a href="/">R4R<sup>&reg;</sup></a><img src="/images/left_menu_bullet.gif"/> 
        <a href="/css/">CSS</a><img src="/images/left_menu_bullet.gif"/>
         <a href="/css/CSS_Interview_Questions_And_Answers/">FAQS</a></div>
        <table>
          <tr>
...
displayContents1("CSS INTER",$pdo);

?>			<h2><?php echo $title; ?></h2>		
  									              <!--Footer  --></td>
          </tr>
        </table></td>
      <td style="width:17%" valign="top"><?php include("../../webtechnology/commonfiles/rightmenu.shtml");?></td>
    </tr>
  </table>
</div>
