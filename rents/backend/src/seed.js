...
async function seed() {
  try {
    ...
    const property1 = await Property.create({
      ...
      city: 'Berlin',
      address: 'Britzer Str. 25, 12439 Berlin, Deutschland',
    ...
    const local3DBedrooms = [
      '/uploads/3d-bedroom-1.png',
      '/uploads/3d-bedroom-2.png',
      '/uploads/3d-bedroom-3.png',
      '/uploads/3d-bedroom-4.png',
      '/uploads/3d-bedroom-5.png',
      '/uploads/3d-bedroom-6.png',
      '/uploads/3d-bedroom-7.png'
    ];
    
    const local3DLivings = [
      '/uploads/3d-living-1.png',
      '/uploads/3d-living-2.png',
      '/uploads/3d-living-3.png',
      '/uploads/3d-living-4.png'
    ];
    
    const local3DKitchen = '/uploads/3d-kitchen.png';
    const local3DBathroom = '/uploads/3d-bathroom.png';
